    ...
    return (
        <div className="min-h-screen relative flex flex-col items-center justify-center p-6 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-[420px]">
                {/* Main Card */}
                <div
                    className="w-full bg-[#111827] border border-white/10 rounded-2xl p-10 flex flex-col items-center shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="relative mb-8">
                        ...
                        <div
                            className="relative w-20 h-20 bg-[#111827] rounded-full border border-white/10 flex items-center justify-center shadow-2xl">
            ...
            <div className="fixed bottom-8 w-full z-10">
                <div
                    className="flex items-center justify-center gap-4 text-[12px] text-[#4B5563] font-medium tracking-wide">
                    <a href="#"
                       className="hover:text-white transition-colors uppercase tracking-widest">{t('login.privacy')}</a>
                    <span className="opacity-30">•</span>
                    <a href="#"
                       className="hover:text-white transition-colors uppercase tracking-widest">{t('login.terms')}</a>
                    <span className="opacity-30">•</span>
                    <a href="#"
                       className="hover:text-white transition-colors uppercase tracking-widest">{t('login.support')}</a>
                </div>
            </div>
        </div>
    );
