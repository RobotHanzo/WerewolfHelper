...
export const GameHeader: React.FC<GameHeaderProps> = ({
  ...
  const btnPrimary =
    'bg-indigo-600 hover:bg-indigo-500 text-white shadow-lg shadow-indigo-900/20 dark:shadow-indigo-900/20';
  const btnSecondary =
    'bg-slate-300 dark:bg-slate-700 hover:bg-slate-400 dark:hover:bg-slate-600 text-slate-800 dark:text-slate-200';
