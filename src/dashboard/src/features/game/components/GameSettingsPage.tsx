  ...
  useEffect(() => {
    ...
    setRoles(
      Array.isArray(rolesArray)
        ? rolesArray.filter((r: unknown): r is string => typeof r === 'string')
        : []
    );
        ...
        <div className="space-y-1.5 shrink-0">
          <div className="flex items-center gap-4">
            ...
            {(saving || justSaved || Object.keys(pendingFields).length > 0) && (
              <div
                className={`flex items-center gap-2 px-3 py-1.5 text-sm font-bold transition-all duration-500 ${
          ...
          <div className="flex flex-col items-end gap-1">
            <div className="flex items-center gap-4">
              <div className="text-right">
                <span className="text-[15px] font-black uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500 block">
                  {t('roles.status')}
                </span>
              ...
              <div
                className={`px-4 py-2 rounded-xl flex items-center gap-2 border-2 transition-all duration-500 ${
                  isReady
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2 text-slate-900 dark:text-white font-black uppercase tracking-[0.15em]">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-white dark:bg-slate-900/40 rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm divide-y divide-slate-100 dark:divide-slate-800/50">
              {[
                {
        ...
        <div className="lg:col-span-5 space-y-6 text-slate-600 dark:text-slate-400">
          ...
          {error && (
            <div className="bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/20 p-4 rounded-2xl flex items-start gap-4">
                      ...
                      .map(([role, count]) => (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-950/50 p-1 rounded-xl border border-slate-100 dark:border-slate-800">
                            ...
                            <span className="min-w-[2rem] text-center font-black text-xl text-slate-900 dark:text-white">
                              {count}
                            </span>
                            <button
