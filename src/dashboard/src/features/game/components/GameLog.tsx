      ...
      >
        {logs.map((log) => {
          ...
          return (
            ...
            >
              <span className="text-slate-400 dark:text-slate-600 font-mono text-xs pt-0.5">
                {log.timestamp
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                {!hasAssignedRoles && (
                  <button
                    onClick={() => onGlobalAction('random_assign')}
                    ...
                    title={t('globalCommands.randomAssign')}
                  >
                    {t('globalCommands.randomAssign')}
                  </button>
                )}
                {hasAssignedRoles && (currentStep === 'SETUP' || !currentStep) && (
                  <button
                    ...
                    title={t('globalCommands.startGame')}
                  >
                ...
                {currentStep !== 'SETUP' && !!currentStep && (
                  ...
                  >
                    {t('globalCommands.skipStage')}
                  </button>
                )}
                <button
                  onClick={() => onGlobalAction('force_police')}
                ...
                <button
                  ...
                  className={`text-xs px-2 py-2 rounded border truncate transition-all duration-200 ${
                    resetConfirming
                ...
                >
                  {resetConfirming
                    ? t('globalCommands.confirmReset')
                    : t('globalCommands.forceReset')}
                </button>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  onClick={() => onGlobalAction('timer_start')}
                ...
                <button
                  onClick={() => onGlobalAction('mute_all')}
                  className="text-xs bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 px-2 py-2 rounded border border-slate-400 dark:border-slate-700 truncate"
                  title={t('voice.muteAll')}
                >
                  {t('voice.muteAll')}
                </button>
                <button
                  onClick={() => onGlobalAction('unmute_all')}
                  className="text-xs bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 px-2 py-2 rounded border border-slate-400 dark:border-slate-700 truncate"
                  title={t('voice.unmuteAll')}
                >
                  {t('voice.unmuteAll')}
                </button>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  onClick={() => onGlobalAction('assign_judge')}
                  ...
                  title={t('admin.assignJudge')}
                >
                  {t('admin.assignJudge')}
                </button>
                <button
                  onClick={() => onGlobalAction('demote_judge')}
                  className="text-xs bg-purple-100 dark:bg-purple-900/20 hover:bg-purple-200 dark:hover:bg-purple-900/40 text-purple-700 dark:text-purple-300 px-2 py-2 rounded border border-purple-300 dark:border-purple-900/30 truncate"
                  title={t('admin.demoteJudge')}
                >
                  {t('admin.demoteJudge')}
                </button>
                <button
                  onClick={() => onGlobalAction('add_spectator')}
                  className="text-xs bg-blue-100 dark:bg-blue-900/20 hover:bg-blue-200 dark:hover:bg-blue-900/40 text-blue-700 dark:text-blue-300 px-2 py-2 rounded border border-blue-300 dark:border-blue-900/30 truncate"
                  title={t('admin.addSpectator')}
                >
                  {t('admin.addSpectator')}
                </button>
                <button
                  onClick={() => onGlobalAction('remove_spectator')}
                  ...
                  title={t('admin.removeSpectator')}
                >
                  {t('admin.removeSpectator')}
                </button>
              </div>
            </div>
          </div>
