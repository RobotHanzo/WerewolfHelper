                ...
                <div className="mt-auto pt-3 border-t border-slate-300 dark:border-slate-800">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                <button onClick={() => onGlobalAction('timer_start')}
                                        ...
                                        title={t('timer.start')}>{t('timer.start')}</button>
                                <button onClick={() => onGlobalAction('mute_all')}
                                        ...
                                        title={t('voice.muteAll')}>{t('voice.muteAll')}</button>
                                <button onClick={() => onGlobalAction('unmute_all')}
                                        className="text-xs bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 px-2 py-2 rounded border border-slate-400 dark:border-slate-700 truncate"
                                        title={t('voice.unmuteAll')}>{t('voice.unmuteAll')}</button>
                            </div>
                        </div>
