...
export const SpeakerCard = ({player, timeLeft, t, readonly, onSkip, onInterrupt}: SpeakerCardProps) => (
    <div className="relative">
        ...
        <div
            ...
            <div className="relative">
                <img src={player.avatar || 'https://cdn.discordapp.com/embed/avatars/0.png'} alt={player.name}
                     className="w-24 h-24 rounded-full border-4 border-indigo-100 dark:border-indigo-900 shadow-sm transition-transform duration-700 hover:rotate-6"/>
                <div
