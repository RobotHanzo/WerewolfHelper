...
export const SpeakerCard = ({
  ...
  <div className="relative w-full">
    ...
    <div className="relative w-full bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-xl border-2 border-indigo-500 flex flex-col items-center gap-4 text-center">
      <>
