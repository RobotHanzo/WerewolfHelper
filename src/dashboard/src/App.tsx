                                ...
                                <>
                                    <Routes>
                                            ...
                                            <>
                                                <div className="flex items-center justify-between mb-2">
                                                    <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                                                        ...
                                                        className="text-slate-500 dark:text-slate-500 text-sm font-normal">({gameState.players.filter(p => p.isAlive).length} {t('players.alive')})</span>
                                                    </h2>
                                                </div>
                                        ...
                                        <Route path="/spectator" element={
                                            <SpectatorView players={gameState.players}
