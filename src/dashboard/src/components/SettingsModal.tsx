...
export const SettingsModal: React.FC<SettingsModalProps> = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-300 dark:border-slate-700 shadow-2xl w-full max-w-md">
                {/* Header */}
                ...
                {/* Footer */}
                <div className="flex items-center justify-end gap-3 p-6 border-t border-slate-300 dark:border-slate-800">
                    <button
                        onClick={onClose}
