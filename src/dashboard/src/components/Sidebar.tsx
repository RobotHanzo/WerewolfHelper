    ...
    <aside className="w-full md:w-64 bg-slate-100 dark:bg-slate-950 border-r border-slate-300 dark:border-slate-800 flex flex-col shrink-0">
      ...
      <div className="p-4 border-t border-slate-300 dark:border-slate-800 space-y-3">
          ...
          <div className="flex items-center gap-3 px-2 py-2 bg-slate-200/50 dark:bg-slate-800/50 rounded-lg">
            ...
            <div className="flex-1 min-w-0">
              ...
              {user.role === 'JUDGE' ? (
                ...
                <span className={`inline-block px-2 py-0.5 text-xs font-medium rounded ${user.role === 'SPECTATOR'
        ...
        <div className="flex items-center gap-3 px-2">
          ...
          <span className={`text-xs font-medium ${isConnected ? 'text-emerald-600 dark:text-emerald-500' : 'text-red-600 dark:text-red-500'} uppercase tracking-wider`}>
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={onLogout} className="flex-1 flex items-center justify-center gap-2 px-4 py-2 text-slate-500 dark:text-slate-500 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/10 rounded-lg transition-colors">
