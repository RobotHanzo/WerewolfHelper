...
export const TimerControlModal: React.FC<TimerControlModalProps> = ({ onClose, onStart }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-md w-full border border-slate-200 dark:border-slate-800 overflow-hidden scale-in-95 animate-in zoom-in-95 duration-200">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="flex items-end justify-center gap-4">
                        <div className="text-center">
                            <label className="block text-xs font-semibold text-slate-500 uppercase mb-1">{t('timer.minutes')}</label>
                            <input
                                type="number"
                                min="0"
                                max="60"
                        ...
                        <div className="text-center">
                            <label className="block text-xs font-semibold text-slate-500 uppercase mb-1">{t('timer.seconds')}</label>
                            <input
                                type="number"
                                min="0"
                                max="59"
