...
export const GameHeader: React.FC<GameHeaderProps> = ({ phase, dayCount, timerSeconds, onGlobalAction, speech, players, readonly = false }) => {
      ...
      <div className="flex items-center gap-6">
        ...
        {currentSpeaker && (
          <>
            ...
            <Link to="speech" className="flex flex-col group cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800/50 px-2 -mx-2 rounded transition-colors">
              ...
              <div className="flex items-center gap-2 text-slate-900 dark:text-slate-100 font-bold">
                ...
                {speech?.endTime && (
                  <span className="text-sm font-mono text-slate-500 bg-slate-100 dark:bg-slate-800 px-1 rounded border border-slate-200 dark:border-slate-700">
                    {(() => {
