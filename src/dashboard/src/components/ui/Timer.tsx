...
export const Timer: React.FC<TimerProps> = ({
  ...
  return (
    <div
      className={`flex items-center gap-3 px-6 py-3 rounded-2xl border transition-all duration-500 shadow-sm
            ${
              isWarning
    ...
    >
      ...
      <div className="flex flex-col min-w-[80px]">
        {label && (
          <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 leading-none mb-1">
            {label}
          </span>
        )}
        <span
          className={`font-mono font-black tabular-nums transition-colors duration-500 leading-none
                    ${sizeClasses[size]}
