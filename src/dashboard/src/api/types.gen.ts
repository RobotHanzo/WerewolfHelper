...
export type RoleActionInstance = {
    actor: number;
    actorRole: string;
    actionDefinitionId?: 'WEREWOLF_KILL' | 'WOLF_YOUNGER_BROTHER_EXTRA_KILL' | 'WITCH_ANTIDOTE' | 'WITCH_POISON' | 'SEER_CHECK' | 'GUARD_PROTECT' | 'HUNTER_REVENGE' | 'WOLF_KING_REVENGE' | 'DARK_MERCHANT_TRADE_SEER' | 'DARK_MERCHANT_TRADE_POISON' | 'DARK_MERCHANT_TRADE_GUN' | 'MERCHANT_SEER_CHECK' | 'MERCHANT_POISON' | 'MERCHANT_GUN' | 'DEATH_RESOLUTION' | 'DEATH';
...
export type StartPoliceEnrollResponse = StartPoliceEnrollResponses[keyof StartPoliceEnrollResponses];
...
export type UpdatePlayerRolesResponse = UpdatePlayerRolesResponses[keyof UpdatePlayerRolesResponses];
...
export type GetReplaysError = GetReplaysErrors[keyof GetReplaysErrors];

export type GetReplaysResponses = {
    /**
     * Replays retrieved
     */
    200: ReplayListResponse;
};

export type GetReplaysResponse = GetReplaysResponses[keyof GetReplaysResponses];
